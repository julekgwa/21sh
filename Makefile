...
SRC = ./src/main.c ./src/commands/ft_commands.c ./src/utils/ft_ctrl_c_signal_handler.c \
	...
	./src/keyboard/ft_ctrl_terminal.c ./src/keyboard/ft_term_utils.c ./src/pipe/ft_manage_pipes.c ./src/buffer/ft_manage_buff.c ./src/history/ft_hist_utils.c
OBJECT = main.o ft_commands.o ft_ctrl_c_signal_handler.o ft_cd.o ft_echo.o \
	...
	ft_term_utils.o ft_ctrl_keyboard.o ft_manage_pipes.o ft_manage_buff.o ft_history.o ft_signals.o ft_hist_utils.o
